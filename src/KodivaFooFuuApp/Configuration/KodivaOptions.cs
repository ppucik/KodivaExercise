...
public class KodivaOptions
{
    ...
    /// </summary>
    [Option('s', "start", Required = false, Default = 1, HelpText = "Začiatok intervalu (default 1)")]
    public int Start { get; init; }

    /// <summary>
    /// Gets or sets the end value for the operation or range.
    /// </summary>
    [Option('e', "end", Required = false, Default = 100, HelpText = "Koniec intervalu (default 100)")]
    public int End { get; init; }

    /// <summary>
    /// Gets the output device type.
    /// </summary>
    [Option('o', "output", Required = false, Default = OutputDeviceType.Console, HelpText = "Typ výstupu (default Console).")]
